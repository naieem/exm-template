	...
	<section class=" wrap-extra">
		<div class="banner-extra content">
            ...
            <div class="right">
						...
						<div class="form-wrapper">
                            <form role="search" method="get" id="searchform" class="searchform acx_search_nf" action="<?php echo $link; ?>" >
                                <div style="display:flex; width:100%;">
                                    <input type="text" value="<?php get_search_query() ?>" name="s" id="search" placeholder="<?php _e('Product page','theme-client') ?>" />
                ...
                <?php if( is_tax( 'product_cat' ) ) : ?>
            		<div class="search_box pc_custom" style="display:none;">
						<div class="form-wrapper">
							<input type="text" name="s" id="search" value="<?php echo $s ?>" placeholder="<?php _e('Category page','theme-client') ?>" ><button><i class="fal fa-search"></i></button>
						</div>
                    </div>
				<?php endif; ?>
